...
const trackByTrackingNumberService = async (
  trackingNumber: string,
  setTrackingError: (error: any) => void
) => {
  try {
...
const returnRequestService = async (
  shipmentId: string,
  formData: FormData,
...
export { trackByTrackingNumberService, returnRequestService };
