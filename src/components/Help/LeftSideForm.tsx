...
const LeftSideForm: React.FC = () => {
  ...
  if (state) {
      updateQueryTypeOptions.push({ id: 'negotiation', label: 'Negotiation', value: 'Negotiation' });
  }
  ...
  const initialValues: FormValues = {
    ...
    message: state ? `I would like to discuss the price for my order ${state.orderNumber}. Please let me know if we can negotiate the pricing.` : '',
  };
                  ...
                  <Autocomplete<OrderOption, false, false, false>
                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        helperText={
                          touched.selectedOrder && typeof errors.orderId === 'string'
                            ? errors.orderId
                            : ''
                        }
                        sx={{
