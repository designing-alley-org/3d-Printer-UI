  ...
  return (
    <Button
      ...
      sx={{
        ...
        backgroundColor:
          props.variant === 'outlined' ? theme.palette.background.paper : '',
        boxShadow:
          props.variant === 'outlined' ? '2px 2px 4px 0px #3B3E4929' : 'none',
        fontWeight: theme.typography.button.fontWeight,
        textTransform: 'none',
        '&:hover': {
          backgroundColor:
            props.variant === 'outlined' && theme.palette.primary.dark,
          color:
            props.variant === 'outlined' && theme.palette.primary.contrastText,
        },
